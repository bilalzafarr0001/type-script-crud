var taskInput = <HTMLInputElement>document.getElementById("new-task");
var searchInput = <HTMLInputElement>document.getElementById("search-task");
var addButton = <HTMLInputElement>document.getElementsByTagName("button")[0];
var incompleteTasksHolder = <HTMLInputElement>(
  document.getElementById("incomplete-tasks")
);
var completedTasksHolder = <HTMLInputElement>(
  document.getElementById("completed-tasks")
);

var index: any; // cell index
var toggleBool: any; // sorting asc, desc
...
// New Task List Item
var createNewTaskElement = function (taskString: any) {
  //   Create List Item
...
var editTask = function () {
  ...
  const table_td_side = this.parentNode;
  ...
  var editInput: any = table_td_side1.getElementsByTagName("input")[1];
...
function compareCellsD(a: any, b: any) {
...
function compareCellsA(a: any, b: any) {
  var aVal = a.cells[index].innerText;
  var bVal = b.cells[index].innerText;
...
function sortingD() {
  var mytbody: HTMLTableSectionElement = <HTMLTableSectionElement>(document.getElementsByTagName("tbody")[0] );
  index = 0;
  // if (toggleBool) {
  //   toggleBool = false;
  // } else {
...
var bindTaskEvents = function (taskListItem: any, checkboxEventHandler: any) {
  //Select taskListItem's children
  var checkBox: any = taskListItem.querySelector("input[type=checkbox]");
  var editButton: any = taskListItem.querySelector("button.edit");
  var deleteButton: any = taskListItem.querySelector("button.delete");
